...
export default function App() {
  ...
  if (loading) return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center'}}>
      <div style={{color:'var(--text-3)',fontSize:14,letterSpacing:'.05em'}}>Loading…</div>
    </div>
  )
        ...
        <aside className={`sidebar ${sidebarOpen?'open':''}`}>
          ...
          <div className="sidebar-footer">
            ...
            <div className="drive-pill">
              ...
              <button onClick={signOut} style={{background:'none',border:'none',color:'var(--text-3)',cursor:'pointer',display:'flex',padding:2}} title="Sign out">
                <LogOut size={13}/>
              </button>
            </div>
          </div>
